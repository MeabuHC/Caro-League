...
function CaroPlayerCard({ playerStats }) {
  return (
    <>
      <div className="img-container w-14 h-14 mr-3">
        <img
      ...
      <div className="player-tagline flex flex-col">
        <div className="player-username flex-1">
          <a className="text-white text-xl cursor-pointer hover:text-gray-300">
            {playerStats.userId.username}
          </a>
        </div>
        <div className="player-rank flex-1 flex items-center mt-1">
          <img
