...
function FriendRequestList() {
  ...
  return (
    <div className="friend-request bg-[#262522] h-[310px] col-start-2 row-start-2 rounded-lg text-[#DFDEDE]">
      {/* Header */}
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleDeclineFriendRequest(req._id, req.senderId.username)
                    }
                  >
                    X
                  </button>
                  <button
                    ...
                    onClick={() =>
                      handleAcceptFriendRequest(req._id, req.senderId.username)
                    }
                  >
                    <CheckOutlined />
                  </button>
